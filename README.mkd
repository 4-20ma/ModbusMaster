...
##History##
  ...
  * 4 Feb 10 -- v0.6 is available. Added documentation via Doxygen comments, modified methods used to get/set storage buffers.  
  * 30 Jan 10 -- v0.5 is available. Added ability to select serial port 0..3, modified methods used to get/set storage arrays, miscellaneous bug fixes.
  * 29 Jan 10 -- v0.3 is available.
  * 25 Jan 10 -- v0.2 is available.
