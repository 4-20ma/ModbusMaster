...
Both full-duplex and half-duplex RS485 transceivers are supported. Callback functions are provided to toggle Data Enable (${DE}$) and Receiver Enable ($\overline{RE}$ ) pins. <span style="text-decoration: overline">Overline test</span>
